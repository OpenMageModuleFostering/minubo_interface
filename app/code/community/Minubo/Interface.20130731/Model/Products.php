 ...
 * */
class Minubo_Interface_Model_Products extends Minubo_Interface_Model_Read_Common
{
    protected function _construct()
    {
        parent::_construct();
        $this->_init('minubo_interface/categories');
    }
    ...
    public function readCategories($lastChangeDate, $lastOrderID, $maxOrderID, $limit)
    {
			...
			//$categories = Mage::getModel('minubo_interface/categories');
	    $categories = $this->getResource()->loadAll();
	    // print_r($categories);
    ...
    public function readRegions($lastChangeDate, $lastOrderID, $maxOrderID, $limit)
    {
      ...
      $regions = $this->getResource()->loadAll();
			// print_r($regions);
